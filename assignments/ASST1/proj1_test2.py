...
def nnObjFunction(params, *args):
    ...
    # print ("The n_input is: ")
    # print ( n_input)
    #
    # print ("The n_hidden is: ")
    # print ( n_hidden)
    #
    # print ("The n_class is: ")
    # print ( n_class)
    #
    # print ("The training_data is: ")
    # print ( training_data)
    #
    # print ("The training_label is: ")
    # print ( training_label)
    #
    # print ("The lambdavel is: ")
    # print ( lambdaval)
    ...
    # (1) computing dot product between data points and weights w1
    a_hidden = np.inner(train_data_bias,w1)
    # print (a_hidden.shape)

    # (2) compute threshold function (sigmoid)
    ...
    # (4) compute threshold function (sigmoid)
    ...
    # place a 1 at the index predicted by labels in each row
    ...
    difference = np.subtract(one_of_k, z_output)
    print ('difference.shape')
    print (difference.shape)
    print ('difference')
    print (difference)

    # again intermediate step for equation (5)
    ...
    # (5) squared loss error function [50000,1]
    squared_loss_error = 0.5 * np.sum(difference_squared, axis = 1)
    print ('squared_loss_error.shape')
    print (squared_loss_error.shape)
    print ('squared_loss_error')
    print (squared_loss_error)

    print('squared_loss_error.shape[0]')
    print(squared_loss_error.shape[0])

    # (6) average error over all training data [1,1]
    average_squared_loss_error = (1 / squared_loss_error.shape[0]) * np.sum(squared_loss_error,axis = 0)
    print ('average_squared_loss_error.shape')
    print (average_squared_loss_error.shape)
    print ('average_squared_loss_error')
    print (average_squared_loss_error)
